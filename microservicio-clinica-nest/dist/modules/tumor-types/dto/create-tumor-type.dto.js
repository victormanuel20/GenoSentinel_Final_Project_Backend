...
class CreateTumorTypeDto {
    name;
    systemAffected;
}
exports.CreateTumorTypeDto = CreateTumorTypeDto;
__decorate([
...
], CreateTumorTypeDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'El sistema afectado es obligatorio' }),
    __metadata("design:type", String)
], CreateTumorTypeDto.prototype, "systemAffected", void 0);
//# sourceMappingURL=create-tumor-type.dto.js.map